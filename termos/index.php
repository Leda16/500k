...
<body>
    ...
    <header class="header">
        ...
        <section class="flex">
            ...
            <a href="home.html" class="logo"> <i class="fas fa-store"></i> Zenite </a>
    ...
    <section class="about">
        ...
        <div class="content">
            <h3>Nos</h3>
            <p>
                A chegada da Zenite ao mercado brasileiro marca o início de uma era revolucionária no
                e-commerce. Com o compromisso de oferecer os melhores preços e uma variedade sem precedentes de
                produtos, esta nova plataforma está pronta para renovar a indústria do comércio eletrônico no Brasil.
                Nossa missão é simples: proporcionar uma experiência de compra online inigualável, combinando
                conveniência, qualidade e acessibilidade.</p>
            <p>Junte-se a nós nessa jornada. Descubra a nova maneira de comprar online, onde qualidade, preço e
                satisfação do cliente caminham juntos. Bem-vindo à renovação do e-commerce brasileiro. Bem-vindo à nossa
                loja.</p>
        </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, culpa non eaque illo laudantium
                        amet. Eius beatae, consequuntur corrupti atque, quod suscipit rem maiores impedit alias labore
                        numquam nihil nostrum.</p>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit explicabo placeat laborum pariatur
                        voluptatibus tenetur impedit assumenda ex reprehenderit soluta ea fugiat error in laboriosam cum
                        dicta consequuntur, sapiente minima quis hic deserunt magnam dignissimos.</p>
                </div>
                ...
                <div class="swiper-slide slide">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus earum quas quo natus quis,
                        accusamus maxime magni molestias eos. Ab nihil magnam, id inventore explicabo ducimus
                        repudiandae unde distinctio iste!</p>
                </div>
