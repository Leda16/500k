            ...
            <div class="container mt-3">
                <div class="input-group mb-3">
                    <input type="text" id="searchTerm" class="form-control"
                        placeholder="Busque aqui pelo nome do produto">
                        ...
                        <div class="list-group">
                            ...
                            <div
                                ...
                                <div class="ms-2 me-auto">
                                    ...
                                    Vendas:
                                    <?= $produto['vendidos'] > 0 ? 'Foi vendido: ' . $produto['vendidos'] . ' item(s)' : 'Sem vendas' ?>
                                </div>
                                <!-- Dropdown de Categorias -->
                                <select class="form-select categoria-dropdown" style="width: auto;"
                                    data-produto-id="<?= $produto['id'] ?>" name="categoria">
                                ...
                                <select class="form-select oferta-dropdown" data-produto-id="<?= $produto['id'] ?>"
                                    name="oferta">
                                    <option value="Sem Oferta"
                                        <?= $produto['oferta'] == 'Sem Oferta' ? 'selected' : '' ?>>Sem Oferta</option>
                                    <option value="Promoção Relâmpago"
                                        <?= $produto['oferta'] == 'Promoção Relâmpago' ? 'selected' : '' ?>>Promoção
                                        Relâmpago</option>
                                    <option value="50% OFF" <?= $produto['oferta'] == '50% OFF' ? 'selected' : '' ?>>
                                        50% OFF</option>
                                </select> <!-- Botão Deletar -->
                                <button class="btn btn-danger ms-3 delete-btn"
                                    data-produto-id="<?= $produto['id'] ?>">Deletar</button>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
