                                                            ...
                                                            <div class="accordion">
                                                                <div class="accordion-item">
                                                                    <div class="accordion-header" id="heading-1">
                                                                        ...
                                                                        <button class="accordion-button contact"
                                                                            type="button" data-bs-toggle="collapse"
                                                                            data-bs-target="#collapse-1"
                                                                            aria-expanded="true"
                                                                            aria-controls="collapse-1">
                                                                            Alterar Trava <span
                                                                                class="badge badge-primary ms-2">Segurança</span>
                                                                        </button>
                                                                    </div>
                                                                    <div id="collapse-1"
                                                                        class="accordion-collapse collapse nestable"
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu"
                                                                                ...
                                                                                <a class="dropdown-item"
                                                                                    href="#"
                                                                                    onclick="alterarTrava('ativada')">Ativada</a>
                                                                                <a class="dropdown-item"
                                                                                    href="#"
                                                                                    onclick="alterarTrava('desativada')">Desativada</a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="accordion-item">
                                                                    <div class="accordion-header" id="heading-2">
                                                                        ...
                                                                        <button class="accordion-button contact"
                                                                            ...
                                                                            Metodo salvar infos <span
                                                                                class="badge badge-primary ms-2">Extras</span>
                                                                        </button>
                                                                    </div>
                                                                    <div id="collapse-2"
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu"
                                                                                ...
                                                                                <a class="dropdown-item"
                                                                                    href="#"
                                                                                    onclick="alterarBackup('json')">JSON</a>
                                                                                <a class="dropdown-item"
                                                                                    href="#"
                                                                                    onclick="alterarBackup('txt')">TXT</a>
                                                                            </div>
                                                                        </div>
