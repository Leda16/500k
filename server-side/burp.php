...
{
    $bots = ['Googlebot', 'Baiduspider', 'ia_archiver', 'R6_FeedFetcher', 'NetcraftSurveyAgent', 'Sogou web spider', 'bingbot', 'Yahoo! Slurp', 'facebookexternalhit', 'PrintfulBot', 'msnbot', 'Twitterbot', 'UnwindFetchor', 'urlresolver', 'Butterfly', 'TweetmemeBot', 'PaperLiBot', 'MJ12bot', 'AhrefsBot', 'Exabot', 'Ezooms', 'YandexBot', 'SearchmetricsBot', 'phishtank', 'PhishTank', 'picsearch', 'TweetedTimes Bot', 'QuerySeekerSpider', 'ShowyouBot', 'woriobot', 'merlinkbot', 'BazQuxBot', 'Kraken', 'SISTRIX Crawler', 'R6_CommentReader', 'magpie-crawler', 'GrapeshotCrawler', 'PercolateCrawler', 'MaxPointCrawler', 'R6_FeedFetcher', 'NetSeer crawler', 'grokkit-crawler', 'SMXCrawler', 'PulseCrawler', 'Y!J-BRW', '80legs.com/webcrawler', 'Mediapartners-Google', 'Spinn3r', 'InAGist', 'Python-urllib', 'NING', 'TencentTraveler', 'Feedfetcher-Google', 'mon.itor.us', 'spbot', 'Feedly', 'bot', 'curl', 'spider', 'crawler'];
    foreach ($bots as $bot) {
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body pb-0">
                                        <div
                                            class="d-flex justify-content-between align-items-center bgl-dark p-3 rounded selling">
                        ...
                        <div class="card">
                            <div class="card-body row d-sm-flex d-block align-items-center">
                                <div class="media col-sm-5 mb-2 mb-sm-0  align-items-center">
                                    <svg class="me-4 min-w50" width="50" height="53" viewBox="0 0 50 53"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="7.11688" height="52.1905" rx="3"
                                            transform="matrix(-1 0 0 1 49.8203 0)" fill="var(--primary)" />
                                        <rect width="7.11688" height="37.9567" rx="3"
                                            transform="matrix(-1 0 0 1 35.5869 14.2338)" fill="var(--primary)" />
                                        <rect width="7.11688" height="16.6061" rx="3"
                                            transform="matrix(-1 0 0 1 21.3535 35.5844)" fill="var(--primary)" />
                                        <rect width="8.0293" height="32.1172" rx="3"
                                            transform="matrix(-1 0 0 1 8.03125 20.0732)" fill="var(--primary)" />
                                    </svg>
                                ...
                                <div class="col-sm-7">
                                    <p class="fs-12 mb-0">Tela Fake Caixa Tem, Encomendada. Personalizada by Leda.
                                        Sintonia Alta Cupula.
                                    </p>
                                </div>
                            </div>
                        </div>
