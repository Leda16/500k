...
(function($) {
 ...
 var karciz = function(){
	...
	var domoPanel = function(){
		const ps = new PerfectScrollbar('.dez-demo-content');
		$('.dez-demo-trigger').on('click', function() {
				$('.dez-demo-panel').addClass('show');
		  });
		  $('.dez-demo-close, .bg-close').on('click', function() {
				$('.dez-demo-panel').removeClass('show');
		  });
		  
		  $('.dez-demo-bx').on('click', function() {
			  $('.dez-demo-bx').removeClass('demo-active');
