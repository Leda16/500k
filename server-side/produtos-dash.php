                                    ...
                                    <div id="smartwizard" style="border: #eee0;">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="step-1" class="tab-pane" role="tabpanel">
                                                <input type="text" name="imagem_url" class="form-control mb-3"
                                                    placeholder="URL da Imagem Principal">
                                                <input type="text" name="imagem_url_hover"
                                                    class="form-control mb-3"
                                                    placeholder="URL da Imagem ao Passar o Mouse">
                                            </div>
                                            ...
                                            <div id="step-2" class="tab-pane" role="tabpanel">
                                                ...
                                                <input type="text" name="preco" class="form-control mb-3"
                                                    placeholder="Preço">
                                ...
                                <form action="produtos-dash.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nomeCategoria"
                                            name="nomeCategoria" placeholder="Digite o nome da categoria" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="imagemCategoria" class="form-label">Link da Imagem da
                                            Categoria</label>
                                        <input type="url" class="form-control" id="imagemCategoria"
                                            name="imagemCategoria" placeholder="Insira o link da imagem" required>
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card mt-5">
                            ...
                            <div class="card-body">
                                <form id="deleteCategoryForm" action="back-scripts/deletarCategoria.php"
                                    method="POST">
                                    <div class="mb-3">
                                        <label for="categoriaParaDeletar" class="form-label">Selecione a
                                            Categoria</label>
                                        <select class="form-select" id="categoriaParaDeletar" name="categoriaId">
                                            <?php echo $optionsHtml; ?>
                                        </select>
                                    </div>
                                    <button type="button" id="deleteCategoryBtn" class="btn btn-danger">Deletar
                                        Categoria</button>
                                </form>
                            </div>
                        </div>
